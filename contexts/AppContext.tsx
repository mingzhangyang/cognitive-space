...
const translations = {
  en: {
    ...
    privacy_updated: "Last updated: February 2, 2026",
    ...
    privacy_ai_body: "If you use the AI analysis feature, the text you submit and a list of existing question titles are sent to the /api/analyze endpoint for classification. That endpoint may be backed by a third-party model provider and may cache responses briefly for performance.",
  ...
  zh: {
    ...
    privacy_title: "隐私政策",
    issues_title: "反馈",
    privacy_updated: "更新日期：2026年2月2日",
    ...
    privacy_ai_body: "当你使用 AI 分析功能时，你提交的文本与已有问题标题列表会发送至 /api/analyze 进行分类处理。该端点可能由第三方模型服务提供，并会为性能进行短暂缓存。",
